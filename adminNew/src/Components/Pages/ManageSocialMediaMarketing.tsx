...
import { deleteSocialMediaMarketingAPI, getAllSocialMediaMarketingAPI } from "../Api/api";
...
const ManageSocialMediaMarketing: React.FC = () => {
  const [socialMediaMarketing, setSocialMediaMarketing] = useState<SocialMediaMarketing[]>([]);
  ...
  const loadData = async (): Promise<void> => {
    try {
      ...
      setSocialMediaMarketing(res.data.data);
    } catch (error: any) {
      toast.error(
  ...
  const filteredSocialMediaMarketing = socialMediaMarketing.filter((item) => {
  ...
  const confirmDelete = async (): Promise<void> => {
    ...
    try {
      const res = await deleteSocialMediaMarketingAPI(selectedId);
      ...
      <div className="rounded-2xl bg-white shadow-lg">
        <div className="overflow-x-auto">
          <table className="min-w-full whitespace-nowrap">
            ...
            <tbody>
              {filteredSocialMediaMarketing.length === 0 ? (
                <tr>
                  <td
                    colSpan={7}
...
export default ManageSocialMediaMarketing;