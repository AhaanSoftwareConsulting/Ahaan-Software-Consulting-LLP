          ...
          >
            ...
            <div className="flex-shrink-0 pt-1">
              <motion.div
                ...
                initial="hidden"
                animate="visible"
                className={`w-8 h-8 md:w-10 md:h-10 lg:w-14 lg:h-14 text-neutral-800 flex items-center justify-center transition-transform duration-300 group-hover:scale-105 ${
                  inView ? "is-visible" : ""
                }`}
              >
