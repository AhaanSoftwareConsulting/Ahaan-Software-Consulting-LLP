  ...
  return (
    <div className="relative w-full flex items-center justify-center bg-slate-50/70 ">
      ...
      <div className="relative max-w-[1600px] mx-auto w-full grid grid-cols-1 md:grid-cols-2 gap-1 lg:gap-4 xl:gap-8 items-center relative z-10 ">
        ...
        <div className="order-2 md:order-1  flex flex-col justify-center space-y-6 xl:space-y-8 text-left px-4 lg:px-6 ">
          <h1 className="text-2xl lg:text-3xl xl:text-5xl font-black text-slate-900 tracking-tight leading-[1.1] min-h-[90px] xl:min-h-[140px]">
            <span
              className={`block transition-all duration-300 transform ${isTransitioning
          ...
          <p
            className={`text-slate-600 lg:text-lg md:text-base text-sm  max-w-2xl transition-all duration-300 delay-70 ${isTransitioning
