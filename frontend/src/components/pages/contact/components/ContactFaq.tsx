...
export const ContactFaq = ({ slug }: FAQSectionProps) => {
      ...
      <div className="mx-auto max-w-[1400px] px-6">
        ...
        <div className="mx-auto mb-12 max-w-3xl text-center">
          ...
          <p className="mt-4 text-sm leading-relaxed text-zinc-600 sm:text-base lg:text-lg">
            ...
            starting a project, consultations, and the next steps for bringing
            your ideas to life.
          </p>
        </div>
        ...
        <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-20">
          ...
          <div className="flex justify-center">
            <img
              src={faqImage}
              alt="Contact Ahaan Software Consulting - Frequently Asked Questions"
